...
void setup()
{
    ...
    // Need to change title (need to remove prob and gate)
...
void loop ()
{
    ...
    // These are being left as examples for how to write the other servo code
    // as soon as that is complete the PIN_LIMIT_SWITCH_GATE and
    // PIN_LIMIT_SWITCH_PROB conditionals can (should) be removed.
