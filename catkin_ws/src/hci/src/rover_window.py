...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.drill_height = QtGui.QRadioButton(self.groupBox_3)
        self.drill_height.setChecked(True)
        self.drill_height.setObjectName(_fromUtf8("drill_height"))
        self.horizontalLayout_2.addWidget(self.drill_height)
