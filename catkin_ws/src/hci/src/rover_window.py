...
#
# Created: Mon Aug 29 11:35:09 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.AugUpLim = QtGui.QLabel(self.centralwidget)
        self.AugUpLim.setObjectName(_fromUtf8("AugUpLim"))
        self.horizontalLayout_4.addWidget(self.AugUpLim)
        self.label_8 = QtGui.QLabel(self.centralwidget)
        self.label_8.setObjectName(_fromUtf8("label_8"))
        self.horizontalLayout_4.addWidget(self.label_8)
        self.AugDnLim = QtGui.QLabel(self.centralwidget)
        self.AugDnLim.setObjectName(_fromUtf8("AugDnLim"))
        self.horizontalLayout_4.addWidget(self.AugDnLim)
        ...
        self.aug_vert_speed = QtGui.QLabel(self.centralwidget)
        self.aug_vert_speed.setObjectName(_fromUtf8("aug_vert_speed"))
        self.horizontalLayout_13.addWidget(self.aug_vert_speed)
        ...
        self.ClawOpenLimit = QtGui.QLabel(self.centralwidget)
        self.ClawOpenLimit.setObjectName(_fromUtf8("ClawOpenLimit"))
        self.gridLayout_8.addWidget(self.ClawOpenLimit, 0, 1, 1, 1)
        self.label_22 = QtGui.QLabel(self.centralwidget)
        self.label_22.setObjectName(_fromUtf8("label_22"))
        self.gridLayout_8.addWidget(self.label_22, 1, 0, 1, 1)
        self.ClawCloseLimit = QtGui.QLabel(self.centralwidget)
        self.ClawCloseLimit.setObjectName(_fromUtf8("ClawCloseLimit"))
        self.gridLayout_8.addWidget(self.ClawCloseLimit, 1, 1, 1, 1)
        ...
        self.rock_container_status_label = QtGui.QLabel(self.centralwidget)
        self.rock_container_status_label.setObjectName(_fromUtf8("rock_container_status_label"))
        self.gridLayout_9.addWidget(self.rock_container_status_label, 0, 1, 1, 1)
        self.soil_container_status_label = QtGui.QLabel(self.centralwidget)
        self.soil_container_status_label.setObjectName(_fromUtf8("soil_container_status_label"))
        self.gridLayout_9.addWidget(self.soil_container_status_label, 1, 1, 1, 1)
        self.soil_container_checkbox = QtGui.QCheckBox(self.centralwidget)
        self.soil_container_checkbox.setObjectName(_fromUtf8("soil_container_checkbox"))
        self.gridLayout_9.addWidget(self.soil_container_checkbox, 1, 0, 1, 1)
        self.rock_container_checkbox = QtGui.QCheckBox(self.centralwidget)
        self.rock_container_checkbox.setObjectName(_fromUtf8("rock_container_checkbox"))
        self.gridLayout_9.addWidget(self.rock_container_checkbox, 0, 0, 1, 1)
        self.augur_drill_enable = QtGui.QCheckBox(self.centralwidget)
        self.augur_drill_enable.setObjectName(_fromUtf8("augur_drill_enable"))
        self.gridLayout_9.addWidget(self.augur_drill_enable, 2, 0, 1, 1)
        self.augur_drill_status = QtGui.QLabel(self.centralwidget)
        self.augur_drill_status.setObjectName(_fromUtf8("augur_drill_status"))
        self.gridLayout_9.addWidget(self.augur_drill_status, 2, 1, 1, 1)
        self.verticalLayout_10.addLayout(self.gridLayout_9)
        self.reverse_drill_enable = QtGui.QPushButton(self.centralwidget)
        self.reverse_drill_enable.setObjectName(_fromUtf8("reverse_drill_enable"))
        self.verticalLayout_10.addWidget(self.reverse_drill_enable)
        ...
        self.ScienceMode = QtGui.QPushButton(self.frame)
        self.ScienceMode.setEnabled(True)
        self.ScienceMode.setCheckable(True)
        self.ScienceMode.setChecked(False)
        self.ScienceMode.setObjectName(_fromUtf8("ScienceMode"))
        self.gridLayout_3.addWidget(self.ScienceMode, 0, 1, 1, 1)
        ...
        MainWindow.setTabOrder(self.DriveMode, self.ScienceMode)
        MainWindow.setTabOrder(self.ScienceMode, self.ArmBaseMode)
        MainWindow.setTabOrder(self.ArmBaseMode, self.function4)
        MainWindow.setTabOrder(self.function4, self.zoomGraph)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_10.setText(_translate("MainWindow", "Aug Up", None))
        self.AugUpLim.setText(_translate("MainWindow", "Ok", None))
        self.label_8.setText(_translate("MainWindow", "Aug Down", None))
        self.AugDnLim.setText(_translate("MainWindow", "Ok", None))
        self.label_9.setText(_translate("MainWindow", "Aug Speed", None))
        self.aug_vert_speed.setText(_translate("MainWindow", "TextLabel", None))
        self.label_17.setText(_translate("MainWindow", "Claw Close", None))
        ...
        self.reverse_drill_enable.setText(_translate("MainWindow", "Empty Drill", None))
