...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pitch1 = QtGui.QRadioButton(self.groupBox_2)
        self.pitch1.setObjectName(_fromUtf8("pitch1"))
        self.gridLayout_2.addWidget(self.pitch1, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pitch1.setText(_translate("MainWindow", "Pitch1", None))
