...
if __name__ == "__main__":
    ...
    ui = WheelStatus()
    ui.show()
    ui.update_motor_status(WheelStatusStruct(False, False, False, False, True, False))
    sys.exit(app.exec_())
