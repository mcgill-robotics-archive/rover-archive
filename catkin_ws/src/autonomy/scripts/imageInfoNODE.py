...
markedPub = rospy.Publisher("waypoint_feed", CompressedImage, queue_size=1)
...
if __name__ == '__main__':
    incomingFeed = rospy.Subscriber("/usb_cam/image_raw", Image, callback, queue_size=1)
    rospy.spin()
