...
if __name__ == '__main__':
    ...
    ap.add_argument("-p", "--panorama", required=True,
        help="path to the panoramic image")
    ap.add_argument("-c", "--coordinate", required=True,
        help="path to the center coordinate of the first (left) frame")
    ap.add_argument("-f", "--frame_width", required=True,
        help="width (pixels) of a single frame in the panorama")
